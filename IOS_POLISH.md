...
**Phase:** Phase 3.1 spot-check approved with one fix-forward (Phase 3.1.5). Phase 3.1.5 shipped pending push: pushDetail/popDetail console.warn + setActive Option A semantics + no-op dedup. typecheck + build:mobile clean. No iPhone re-test needed.
