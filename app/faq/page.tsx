...
const FAQ_DATA: FAQSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How are cash-outs handled?', a: 'Cash-outs are recorded as a win or loss based on your export\'s actual profit/net figure for that bet, same as any other settled bet. If your export doesn\'t include a usable profit value for a cash-out, we record it as a $0 push rather than guess.' },
    ],
  },
  {
