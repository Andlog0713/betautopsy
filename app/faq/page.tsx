...
const FAQ_DATA: FAQSection[] = [
  {
    ...
    items: [
      { q: 'What is BetAutopsy?', a: 'BetAutopsy is an AI-powered behavioral analysis tool for sports bettors. You upload your bet history and we analyze it for cognitive biases, emotional patterns, and strategic leaks — the stuff your basic tracker can\'t tell you. Think of it like a sports psychologist reviewing your game tape, except it takes 20 seconds and costs less than a bad parlay.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How many bets do I need for a meaningful analysis?', a: 'The more the better, but you\'ll start seeing patterns with as few as 30–50 bets. The free tier analyzes your 50 most recent bets. Pro analyzes up to 2,000, and Sharp up to 5,000. Analyses based on very small samples will note where statistical confidence is limited.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Can I run multiple reports?', a: 'Free users get 1 report (up to 50 bets). Pro and Sharp users can run unlimited reports with up to 2,000 or 5,000 bets respectively. This lets you track your behavioral progress over time — run a report each month and see if your Emotion Score is improving.' },
      { q: 'What is the Leak Prioritizer? (Sharp only)', a: 'The Leak Prioritizer takes all your detected leaks and ranks them by estimated dollar impact — so you know exactly which behavior to fix first for the biggest financial improvement. Instead of working on everything at once, you get a ranked action list with the most expensive leaks at the top.' },
      { q: 'What is the What-If Simulator? (Sharp only)', a: 'The What-If Simulator lets you model how your P&L would change if you removed specific behaviors. For example: "What if I had never placed a parlay?" or "What if I had flat-staked every bet?" It runs the calculation against your actual history and shows you the counterfactual result.' },
      { q: 'What is the Weekly Digest? (Pro and Sharp)', a: 'A weekly email that recaps your recent betting activity, flags any new patterns, and tracks whether your behavioral metrics are improving week over week. It\'s a lightweight accountability layer so you don\'t have to remember to log in and check.' },
    ],
  },
  {
