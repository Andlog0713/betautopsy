...
const FAQ_DATA: FAQSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How are cash-outs handled?', a: 'Cash-outs are currently recorded as $0 profit, not your actual cash-out amount, since exported data doesn\'t reliably distinguish a profitable cash-out from a loss. If you cash out often, your reported P&L and ROI may not fully reflect those bets.' },
    ],
  },
  {
