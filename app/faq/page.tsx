...
const FAQ_DATA: FAQSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How are cash-outs handled?', a: 'Cash-outs are recorded as a win or loss based on your export\'s actual profit/net figure for that bet, same as any other settled bet. If your export doesn\'t include a usable profit value for a cash-out, we record it as $0 rather than guess. Cash-outs uploaded before August 18, 2026 were recorded as $0 regardless of their actual value, and that\'s permanent - we don\'t retain your original upload, and re-uploading the same history won\'t update the existing rows, since a matching date/description/odds/stake is treated as an existing bet and skipped rather than corrected. If you cashed out often before that date, your historical P&L and ROI may not fully reflect those bets.' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What if my report shows signs of problem gambling?', a: `We take this seriously. If your data shows patterns consistent with problem gambling (extreme loss chasing, rapidly escalating stakes, very high Emotion Scores), your report will include a direct wellness flag with links to support resources. We will never frame these patterns as something to "optimize." If you or someone you know may have a gambling problem, call or text ${PROBLEM_GAMBLING_HELPLINE}, or open our support page for direct help links.` },
