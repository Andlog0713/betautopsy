...
const FAQ_DATA: FAQSection[] = [
  {
    ...
    items: [
      ...
      { q: 'Is BetAutopsy a bet tracker?', a: 'No. We\'re the intelligence and control layer on top of your tracker. Tools like Pikkit track your bets. We tell you what your betting behavior actually means and help you turn those findings into live rules, cooldowns, and guardrails before the next bad session starts.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What is the Weekly Digest?', a: 'A weekly email that recaps your recent betting activity, flags any new patterns, and points back to the rules or guardrails that matter most right now. It\'s a lightweight accountability layer so you don\'t have to remember to log in and check. Available with Pro subscription.' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What if my report shows signs of problem gambling?', a: `We take this seriously. If your data shows patterns consistent with problem gambling (extreme loss chasing, rapidly escalating stakes, very high Emotion Scores, repeated heated sessions), the product should move toward more friction, not more hype: stronger rules, cooldowns, direct wellness flags, and support resources. We will never frame these patterns as something to "optimize." If you or someone you know may have a gambling problem, call or text ${PROBLEM_GAMBLING_HELPLINE}, or open our support page for direct help links.` },
      { q: 'Does BetAutopsy help before I place a bet, or only after?', a: 'It does both. Reports explain the leaks after the fact, but the product also uses pre-bet check-ins, live rules, cooldowns, and repeat-risk alerts to interrupt the same pattern before it compounds. The goal is restraint infrastructure, not just clever diagnosis.' },
