    ...
    <main className="min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 pt-28 pb-16">
        ...
        <div className="space-y-10 text-sm text-ink-600 leading-relaxed">
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">1. Acceptance of terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">2. Eligibility</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">3. Description of service</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">4. Account registration</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">6. User content and data</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">7. Acceptable use</h2>
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">8. Intellectual property</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">9. Third-party services</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">10. Disclaimers</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">11. Limitation of liability</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">12. Indemnification</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">13. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">14. Governing law</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">15. Changes to these terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-[#F0F2F5] mb-3">16. Contact</h2>
            <p>
