...
export default function RootLayout({
  ...
  const appJsonLd = {
    ...
    operatingSystem: 'Web',
    description: 'Upload your bet history and get an AI-powered behavioral analysis — cognitive biases, strategic leaks, emotional patterns, and a personalized action plan.',
    offers: [
