  ...
  return (
    <div className="case-card p-8 animate-fade-in">
      ...
      <button
        ...
        className="text-fg-muted hover:text-scalpel transition-colors mt-3 block mx-auto font-mono text-xs min-h-[44px] px-3 inline-flex items-center justify-center"
      >
