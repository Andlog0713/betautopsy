...
<tr><td style="background-color:#0D1117;padding:24px 32px">
  <span style="font-size:22px;font-weight:700;color:#ffffff">Bet<span style="color:#00C853">Autopsy</span></span>
</td></tr>
...
<tr><td style="padding:32px">
  ...
  <table cellpadding="0" cellspacing="0" style="width:100%;margin-bottom:24px"><tbody>
    <tr><td style="padding:8px 0;font-size:15px;color:#1a1a1a">
      <span style="color:#00C853;font-weight:600">✓</span>&nbsp;&nbsp;Unlimited bets &amp; reports
    </td></tr>
    <tr><td style="padding:8px 0;font-size:15px;color:#1a1a1a">
      <span style="color:#00C853;font-weight:600">✓</span>&nbsp;&nbsp;Full bias suite &amp; strategic leaks
    </td></tr>
    <tr><td style="padding:8px 0;font-size:15px;color:#1a1a1a">
      <span style="color:#00C853;font-weight:600">✓</span>&nbsp;&nbsp;What-If Simulator
    </td></tr>
    <tr><td style="padding:8px 0;font-size:15px;color:#1a1a1a">
      <span style="color:#00C853;font-weight:600">✓</span>&nbsp;&nbsp;Leak Prioritizer — ranked by $ impact
    </td></tr>
    <tr><td style="padding:8px 0;font-size:15px;color:#1a1a1a">
      <span style="color:#00C853;font-weight:600">✓</span>&nbsp;&nbsp;Progress tracking &amp; weekly digests
    </td></tr>
    <tr><td style="padding:8px 0;font-size:15px;color:#1a1a1a">
      <span style="color:#00C853;font-weight:600">✓</span>&nbsp;&nbsp;Early access to every new feature
    </td></tr>
  </tbody></table>
  ...
  <div style="text-align:center;margin:32px 0">
    <a href="https://www.betautopsy.com/dashboard" style="display:inline-block;background:#00C853;color:#ffffff;font-size:16px;font-weight:700;padding:14px 40px;border-radius:10px;text-decoration:none">Go to Your Dashboard →</a>
  </div>
