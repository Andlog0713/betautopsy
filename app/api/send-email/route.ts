...
<tr><td style="background-color:#0A0E12;padding:24px 32px">
  <span style="font-size:22px;font-weight:700;color:#ffffff"><span style="font-weight:900">BET</span><span style="font-weight:300;color:#FACC15">AUTOPSY</span></span>
</td></tr>
...
<tr><td style="padding:32px">
  ...
  <table cellpadding="0" cellspacing="0" style="width:100%;margin-bottom:24px"><tbody>
    <tr><td style="padding:8px 0;font-size:15px;color:#1a1a1a">
      <span style="color:#00DC82;font-weight:600">✓</span>&nbsp;&nbsp;Unlimited bets &amp; reports
    </td></tr>
    <tr><td style="padding:8px 0;font-size:15px;color:#1a1a1a">
      <span style="color:#00DC82;font-weight:600">✓</span>&nbsp;&nbsp;Full bias suite &amp; strategic leaks
    </td></tr>
    <tr><td style="padding:8px 0;font-size:15px;color:#1a1a1a">
    ...
    <tr><td style="padding:8px 0;font-size:15px;color:#1a1a1a">
      <span style="color:#00DC82;font-weight:600">✓</span>&nbsp;&nbsp;Early access to every new feature
    </td></tr>
  </tbody></table>
