...
.c{max-width:400px;padding:40px 20px}a{color:#00FFCB;text-decoration:none}a:hover{text-decoration:underline}.f{margin-top:40px;font-size:11px;color:#5A5C6F;line-height:1.6}</style>
...
export async function GET(request: Request) {
  ...
  return htmlPage('Unsubscribed', `
    <div style="font-size:18px;font-weight:700;margin-bottom:24px"><span style="font-weight:900">BET</span><span style="font-weight:300;color:#00FFCB">AUTOPSY</span></div>
