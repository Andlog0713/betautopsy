    ...
    <main id="main-content" className="min-h-screen">
      ...
      <section className="bg-surface-1 border-y border-border-subtle py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-6">
          <div className="case-header animate-header-reveal mb-8">PROTOCOL // HOW IT WORKS</div>
          <ProductShowcase />
        </div>
      </section>
      </AnimatedSection>
      ...
      <section className="bg-surface-2 border-y border-border-subtle py-16 md:py-20 relative overflow-hidden" id="sample">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <div className="case-header animate-header-reveal mb-3">EXHIBIT A // PRO TIER SAMPLE</div>
      ...
      <section id="pricing" className="bg-surface-1 border-y border-border-subtle py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <div className="case-header animate-header-reveal mb-2">PRICING // ACCESS LEVELS</div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        <div className="case-header animate-header-reveal mb-3">FROM THE POST-MORTEM</div>
