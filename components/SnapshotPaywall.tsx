    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="bg-base/95 border border-white/[0.08] rounded-sm p-8 max-w-md text-center shadow-2xl">
          <div className="w-12 h-12 rounded-none bg-scalpel/10 flex items-center justify-center mx-auto mb-4">
            <svg className="w-6 h-6 text-scalpel" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
