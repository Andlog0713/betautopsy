      ...
      content: (
        <div className="w-full overflow-hidden relative h-full card p-6 md:p-10">
          ...
          <div className="card-tier-2 p-4 space-y-2.5">
            <div className="flex items-center gap-3 p-2.5 bg-white/[0.03] rounded-md">
      ...
      content: (
        <div className="w-full overflow-hidden relative h-full card p-6 md:p-10">
          ...
          <div className="space-y-2.5">
            <div className="flex items-center justify-between p-3 bg-white/[0.03] rounded-md border-l-2 border-l-bleed">
            ...
            <div className="flex items-center justify-between p-3 bg-white/[0.03] rounded-md border-l-2 border-l-caution">
              <div className="flex items-center gap-2 min-w-0">
