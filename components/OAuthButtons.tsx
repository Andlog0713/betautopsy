  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 rounded-sm border border-border-subtle bg-base px-4 min-h-[44px] text-sm font-medium text-fg-bright hover:bg-surface-1 transition-colors disabled:opacity-50"
      >
      ...
      {error && (
        <p className="text-loss text-sm text-center mt-3">{error}</p>
      )}
    </div>
  );
}
