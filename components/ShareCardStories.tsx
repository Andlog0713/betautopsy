...
const ARCHETYPE_BG: Record<string, string> = {
  ...
  'Sharp Sleeper': 'repeating-linear-gradient(0deg, rgba(0,201,167,0.07) 0px, transparent 3px, transparent 14px)',
...
function getArchColor(name: string): string {
  const map: Record<string, string> = {
    'The Natural': '#00C9A7', 'Sharp Sleeper': '#00C9A7', 'Heated Bettor': '#f97316',
